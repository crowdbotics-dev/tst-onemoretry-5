"""
Django settings for tst_onemoretry_5 project.
...
ROOT_URLCONF = 'tst_onemoretry_5.urls'
...
WSGI_APPLICATION = 'tst_onemoretry_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-onemoretry Support <support@tst-onemoretry-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_onemoretry_5 API",
    "DESCRIPTION": "API documentation for tst_onemoretry_5 App",
    "VERSION": "v1",
}
